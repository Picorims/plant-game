    ...
    HTML = {
        ...
        credits:{
            ...
            title: {
                ...
                dev_content:        document.getElementById("credits_dev_content"),
                graphism:           document.getElementById("credits_graphism"),
                graphism_content:   document.getElementById("credits_graphism_content"),
                ...
                sfx_content:        document.getElementById("credits_sfx_content"),
                libraries:          document.getElementById("credits_libraries"),
                libraries_content:  document.getElementById("credits_libraries_content"),
